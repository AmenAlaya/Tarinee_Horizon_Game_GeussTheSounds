...
public class Game_Over_2_SaveSystem
{
    ...
    {
        PlayerPrefs.SetString(Game_Over_2_Constants.LEVEL_REACHED_IN_MAIN_APP, PlayerPrefs.GetString(Game_Over_2_Constants.LEVEL_REACHED_IN_MAIN_APP, string.Empty) + Game_Over_2_Constants.GAME_REFRENCE + "-");
        ...
        {
            PlayerPrefs.SetInt(Game_Over_2_Constants.GAME_REFRENCE + Game_Over_2_Constants.STARS, 3);
        }
        else if (score >= (index * 3) - (index * 2))
        {
            PlayerPrefs.SetInt(Game_Over_2_Constants.GAME_REFRENCE + Game_Over_2_Constants.STARS, 2);
        }
        else
        {
            PlayerPrefs.SetInt(Game_Over_2_Constants.GAME_REFRENCE + Game_Over_2_Constants.STARS, 1);
        }
    }
