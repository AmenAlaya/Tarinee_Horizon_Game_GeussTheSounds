...
public class Game_Over_2_Ferid : MonoBehaviour
{
    ...
    {
        upperAccessory.SetCategoryAndLabel(Game_Over_2_Constants.UPPER_ACCESSORIE, Game_Over_2_Manager.instance.Get_User().avatarUpperAccessories.ToString());
        downAccessory.SetCategoryAndLabel(Game_Over_2_Constants.DOWN_ACCESSORIE, Game_Over_2_Manager.instance.Get_User().avatarLowerAccessories.ToString());
